  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: 'projets',          component: () => import('@/pages/PublicProjectsGalleryPage.vue'), meta: { title: 'Projets d\'upcycling' } },
        { path: 'projets/:id',      component: () => import('@/pages/PublicProjectDetailPage.vue'),   meta: { title: 'Projet' } },
        ...
        { path: 'profil/pro/prestations',  component: () => import('@/pages/ProviderPrestationsPage.vue'),  meta: { title: 'Mes Prestations' } },
        { path: 'profil/pro/reservations', component: () => import('@/pages/ProviderReservationsPage.vue'), meta: { title: 'Mes Réservations' } },
...

    {
      ...
      children: [
        ...
        { path: 'tickets',       component: () => import('@/pages/TicketsAdminPage.vue'),  meta: { title: 'Tickets', staff: true } },
        { path: 'legal',         component: () => import('@/pages/LegalAdminPage.vue'),    meta: { title: 'Documents légaux' } },
