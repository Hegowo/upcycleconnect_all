        ...
        <div class="mt-6 pt-4 border-t border-red-100">
          <div class="flex items-start gap-3 rounded-xl bg-red-50 border border-red-200 p-4">
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="text-xs text-red-700 mt-0.5">Suppression définitive et irréversible de l'utilisateur et de toutes ses données. Un e-mail de confirmation RGPD lui sera envoyé.</p>
            </div>
            <button
